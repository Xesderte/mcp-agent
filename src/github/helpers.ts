...
export async function createCommitFlow(
    ...
    // Paso 2: Obtener el commit base y su árbol estructural (Tree)
    ...
    // Paso 3: Crear el Blob (Convertir tu texto/código en un objeto binario de Git)
    ...
    const newTreeData = await operations.execute(() =>
        ...
        tree: [
            {
            path: path,
            mode: '100644', // Código interno de Git para "Archivo Regular"
            type: 'blob',
            sha: blobSha,
            },
        ],
